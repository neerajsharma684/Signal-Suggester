...
public class US_Stocks implements ActionListener, MenuListener{
    Connection con= null;
    Statement stmt = null;
    JFrame frame = new JFrame();
    String[] indices_values = {"Nasdaq_100", "Dow_Jones", "S_and_P_100"};
    JMenuBar menubar;
    ...
    US_Stocks(){
        ...
        hint = new JLabel("To add multiple Ticker add coma (,) Eg.(AAPL, TSLA)");
        ...
        frame.setTitle("Signal Suggester - US Stocks");
